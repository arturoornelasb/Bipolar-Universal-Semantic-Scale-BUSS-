...
#!/usr/bin/env python3
"""
Evaluación Cuantitativa de BUSS-LoRA (v2.1 - Pares Reales)

Este script carga el modelo BUSS-LoRA entrenado (v5.0 - IMDB) y mide
la distancia semántica real entre sus generaciones.

Utiliza un modelo SBERT (SentenceTransformers) pre-entrenado para la
...
MODEL_PATH = "./buss_lora_final_v5_imdb" 
